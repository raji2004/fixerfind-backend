...
exports.Mailer = async ( email, pin) => {
  ...
  const mailOption = {
    ...
    <div style="font-size:small;font-family:'Gill Sans','Gill Sans MT',Calibri,'Trebuchet MS',sans-serif;margin:4px;color:blue;text-decoration:underline"><a href="mailto:info@fixerfind.co">info@fixerfind.co</a>|
    07063455750</div>
    </div>
    </div>
    </footer>
